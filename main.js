console.log("made by cbozey this is not found on discord so stop  @XeComputerboi from reddit anyways thanks fo using.")
//requires
...
function ads() {
  ...
  console.log("Made by cbozey and a spical fuck you to @Xecomputerboi from reddit this aint from discord")
  console.log("youtube: cbozey_boy19")
  console.log("==================\n")
}
ads()
...
console.clear()
console.log("Joining bots THAT WHERE MADE BY CBOZEY_BOY19 ITS MY YT NAME")
spam()//YAY WE DID IT6516365
EN
